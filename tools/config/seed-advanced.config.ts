...
export class SeedAdvancedConfig extends SeedConfig {
  ...
  constructor() {
    ...
    this.SYSTEM_BUILDER_CONFIG.paths['@ngrx/store-devtools'] = `node_modules/@ngrx/store-devtools/index.js`;
    this.SYSTEM_BUILDER_CONFIG.paths['@ngrx/store-log-monitor'] = `node_modules/@ngrx/store-log-monitor/index.js`;
  }
}
